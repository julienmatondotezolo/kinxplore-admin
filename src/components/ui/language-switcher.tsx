      ...
      >
        ...
        <div className="relative flex items-center gap-2">
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="h-4 w-4 text-gray-900 transition-transform duration-300 group-hover:rotate-12"
          >
          ...
          <svg
            ...
            viewBox="0 0 20 20"
            fill="currentColor"
            className={`h-4 w-4 text-gray-900 transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`}
          >
            <path
              fillRule="evenodd"
                  ...
                  return (
                    <button
                      ...
                      className={`group relative flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-all duration-200 ${
                        isActive
                          ? "bg-black/5 font-semibold text-gray-900"
                          : "hover:bg-gray-50 text-gray-900"
                      } ${isPending ? "opacity-50" : ""}`}
                    >
                      {/* Active indicator */}
                      {isActive && (
                        <div className="absolute left-0 h-8 w-1 rounded-r-full bg-black" />
                      )}
                      ...
                      <div className="flex flex-1 flex-col items-start">
                        ...
                        <span className="text-xs text-gray-600">{lang.shortLabel}</span>
                      </div>
